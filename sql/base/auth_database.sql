...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='Account System';
...
INSERT INTO `rbac_default_permissions` (`secId`, `permissionId`, `realmId`) VALUES (3,192,-1),(2,193,-1),(1,194,-1),(0,195,-1);
...
INSERT INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`, `Region`, `Battlegroup`) VALUES (1,'LegionCore','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,26972,1,1);
...
INSERT INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES ('2017_11_09_auth_movementforce_commands.sql','0173D94C47B2CB97EF1DA85F0148B114D4E795BF','RELEASED','2018-06-27 14:43:07',217),('2017_11_15_01_auth_updates.sql','C5393637EDA2AB6C89C3B1F951C47FAA17B7959C','RELEASED','2018-06-27 14:43:07',17),('2017_12_05_01_rbac_list_quests.sql','D26DF52719C538746FFF84EC308A6A4A752B5EE3','RELEASED','2018-06-27 14:43:07',115),('2017_12_30_00_auth.sql','F360E9555AC68E28834E3FF807E4E37A090EF363','RELEASED','2018-06-27 14:43:07',175),('2018_02_28_00_auth.sql','E92EF4ABF7FA0C66649E1633DD0459F44C09EB83','RELEASED','2018-06-27 14:43:07',45),('2018_03_14_00_auth.sql','2D71E93DF7419A30D0D21D8A80CF05698302575A','RELEASED','2018-06-27 14:43:07',217),('2018_04_06_00_auth.sql','D8416F0C4751763202B1997C81423F6EE2FCF9A6','RELEASED','2018-06-27 14:43:07',41),('2018_05_03_00_auth_blackmarket.sql','B3C1D83C37712F0E37DE4061A7385A03D764DC94','RELEASED','2018-06-27 14:43:07',116),('2018_05_19_00_auth.sql','D6A7053803C2570E2C6CDE0A58C6A1DC30867D71','RELEASED','2018-06-27 14:43:07',120),('2018_05_24_00_auth.sql','B98FD71AAA13810856729E034E6B8C9F8D5D4F6B','RELEASED','2018-06-27 14:43:07',33),('2018_06_14_00_auth.sql','67EAB915BF0C7F2D410BE45F885A1A39D42C8C14','RELEASED','2018-06-27 14:43:08',88),('2018_06_29_00_auth.sql','03AAEA7E52848FA5522C3F0C6D9C38B988407480','RELEASED','2018-06-30 10:47:21',116),('2018_07_02_00_auth.sql','C66AAE9D0A9C96949799D1C87AEA9FAE72F1A89C','RELEASED','2018-07-03 07:17:19',198);
...
INSERT INTO `updates_include` (`path`, `state`) VALUES ('$/sql/LegionCore/auth','RELEASED');
...
-- Dump completed on 2022-02-05 13:43:51
