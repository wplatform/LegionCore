...
class spell_general_nazgrim_aftershock : public SpellScriptLoader
{
    public:
        ...
        class spell_general_nazgrim_aftershock_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_general_nazgrim_aftershock_SpellScript::FilterTargets, EFFECT_0, TARGET_ENNEMY_IN_LINE);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_general_nazgrim_aftershock_SpellScript::FilterTargets, EFFECT_1, TARGET_ENNEMY_IN_LINE);
            }
